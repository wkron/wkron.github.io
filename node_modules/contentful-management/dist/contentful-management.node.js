...
class RestAdapter {
  ...
  makeRequest({
    ...
    return _asyncToGenerator(function* () {
      ...
      return yield endpoint(_this.http, params, payload, _objectSpread(_objectSpread(_objectSpread({}, requiredHeaders), _this.params.headers), headers));
    })();
  }
...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.42.3"}`, params.application, params.integration, params.feature);
